...
@app.route('/')
def deploy_ml_model():
    return 'This is the page for TRSS ML model deployment'
...
def predict_with_ml_model():
    ...
    vectorizer_file_path = 'MachineLearningPrototype/data/TempData/vectorizer_file.pk'
    ...
    standardScaler_file_path = 'MachineLearningPrototype/data/TempData/standardScaler_file.pk'
    ...
    ml_model_path = 'MachineLearningPrototype/MLModel.joblib'
    ...
    num2name_file_path = 'MachineLearningPrototype/data/TempData/num2name_file'
